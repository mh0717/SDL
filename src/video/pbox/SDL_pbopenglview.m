...
@implementation SDL_pbopenglview {
    
}

- (int) backingWidth {
    return [(SDL_pbuikitopenglview*)self.view backingWidth];
}
                      ...
                      context:(EAGLContext *)glcontext
{
    if ((self = [super initWithFrame:frame])) {
        void (^handler)(void) = ^{
            self.view = [[SDL_pbuikitopenglview alloc] initWithFrame:frame scale:scale retainBacking:retained rBits:rBits gBits:gBits bBits:bBits aBits:aBits depthBits:depthBits stencilBits:stencilBits sRGB:sRGB multisamples:multisamples context:glcontext];
        };
...
{
    return [(SDL_pbuikitopenglview*)self.view drawableRenderbuffer];
}

- (GLuint)drawableFramebuffer
{
    return [(SDL_pbuikitopenglview*)self.view drawableFramebuffer];
}

- (GLuint)msaaResolveFramebuffer
{
    return [(SDL_pbuikitopenglview*)self.view msaaResolveFramebuffer];
}

- (void)updateFrame
{
    [(SDL_pbuikitopenglview*)self.view updateFrame];
}
...
@implementation SDL_pbuikitopenglview {
