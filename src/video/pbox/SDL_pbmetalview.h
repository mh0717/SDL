...
@interface SDL_pbmetalview : SDL_pbview
...
@interface SDL_pbuikitmetalview : SDL_pbuiview
...
SDL_MetalView PB_Metal_CreateView(_THIS, SDL_Window * window);
void PB_Metal_DestroyView(_THIS, SDL_MetalView view);
void *PB_Metal_GetLayer(_THIS, SDL_MetalView view);
void PB_Metal_GetDrawableSize(_THIS, SDL_Window * window, int * w, int * h);
