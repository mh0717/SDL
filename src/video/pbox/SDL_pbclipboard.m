...
int
PB_SetClipboardText(_THIS, const char *text)
{
#if TARGET_OS_TV
...
void
PB_InitClipboard(_THIS)
{
#if !TARGET_OS_TV
    @autoreleasepool {
        SDL_PBVideoData *data = (__bridge SDL_PBVideoData *) _this->driverdata;
